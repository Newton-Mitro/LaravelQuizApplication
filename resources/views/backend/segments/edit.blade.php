...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-body">
                    <form method="POST" action="{{ route('segment.update',['id'=>$segment->id]) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="segment_name" type="text"
                                       ...
                                       value="{{ $segment->segment_name }}" autocomplete="segment_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="segment_status" id="segment_status">
                                    <option {{($segment->segment_status == 1)?'selected':''}} name="segment_status" value="1">Active</option>
                                    <option {{($segment->segment_status == 0)?'selected':''}} name="segment_status" value="0">In-Active</option>
                                </select>
